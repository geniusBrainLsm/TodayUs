...
class ApiEndpoints {
  ...
  static String checkNicknameAvailability(String nickname) =>
      '$baseUrl/api/users/check-nickname?nickname=${Uri.encodeComponent(nickname)}';
  ...
  static String validateInviteCode(String code) =>
      '$baseUrl/api/couples/invite-code/validate?code=$code';
  ...
  static String get weeklyEmotionSummary =>
      '$baseUrl/api/diaries/weekly-emotion-summary';
  static String get coupleSummary => '$baseUrl/api/diaries/couple-summary';

  /// 일기 댓글
  static String diaryComments(int diaryId) =>
      '$baseUrl/api/diaries/$diaryId/comments';

  /// 일기 이미지 업로드
  static String diaryImage(int diaryId) =>
      '$baseUrl/api/diaries/$diaryId/image';
  ...
  static String timeCapsuleById(int timeCapsuleId) =>
      '$baseUrl/api/time-capsules/$timeCapsuleId';
  static String timeCapsuleOpen(int timeCapsuleId) =>
      '$baseUrl/api/time-capsules/$timeCapsuleId/open';

  /// 타임캡슐 관리
  static String get openableTimeCapsules =>
      '$baseUrl/api/time-capsules/openable';
  ...
  /// 메시지 상태 관리
  static String markAsDelivered(int messageId) =>
      '$baseUrl/api/couple-messages/$messageId/delivered';
  static String markAsRead(int messageId) =>
      '$baseUrl/api/couple-messages/$messageId/read';
  ...
  /// 날짜 범위 쿼리 추가
  static String withDateRange(String endpoint,
  ...
  /// 정렬 쿼리 추가
  static String withSort(String endpoint, String sortBy,
      {bool ascending = true}) {
